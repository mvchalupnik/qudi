...
class DAQ(Instrument):
    ...
    def get_analog_voltages(self, channel_list):
        ...
        self._check_error(self.nidaq.DAQmxCreateAIVoltageChan(get_voltage_taskHandle, daq_channels_str, "",
                                                              DAQmx_Val_Diff, # Changed the terminal configuration to DIFFERENTIAL #DAQmx_Val_Cfg_Default,
                                                              float64(-10.0), float64(10.0), #  ATTENTION! These parameters are not defined by the self.settings
                                                              DAQmx_Val_Volts, None))
